---
title: "Fiserv to acquire StoneCastle Cash Management for stablecoin"
date: 2025-10-05
tags:
  - company/fiserv
  - company/stonecastle
  ...
  - type/m-and-a
sources:
  - https://www.businesswire.com/news/home/20250929433347/en/Fiserv-Signs-Definitive-Agreement-to-Acquire-StoneCastle-Cash-Management
  - https://www.paymentsdive.com/news/fiserv-buys-cash-manager-to-boost-stablecoin/761360
status: tagged
n_mentions: 1
channels:
...
# Fiserv to acquire StoneCastle Cash Management for stablecoin

> [!info] 2025-10-05 · 1 упоминаний · 1 источника(ов) с текстом
> Каналы: This Week in Fintech

## Агрегированный текст (из дайджестов)

[This Week in Fintech] Fiservannouncedplans to acquire StoneCastle Cash Management to bolster its FIUSD stablecoin by the first quarter of 2026.
...
_Enabling a source of cost-efficient, stable funding for financial institutions_

_Helping merchants, financial institutions and fintechs best manage cash reserves backing FIUSD stablecoin issuance_

MILWAUKEE--(BUSINESS WIRE)--Fiserv, Inc. (NYSE: FI), a leading global provider of payments and financial services technology, today announced it has signed a definitive agreement to acquire StoneCastle Cash Management. StoneCastle enables its network of depository institutions, primarily community banks and credit unions, to easily access stable, cost-efficient deposit funding from thousands of businesses and enterprise customers holding cash balances.
...
The transaction is expected to close by Q1 2026 subject to regulatory approvals and other customary closing conditions. Financial terms of the transaction have not been disclosed.
...
Founded in 2003, SCP has a long and successful track record of developing businesses which focus primarily on cost-efficient bank funding and solving business inefficiencies. StoneCastle Cash Management was founded by SCP in 2009 to provide superior deposit funding solutions for depository institutions and enhanced accounts for depositors. Its services are used by a wide range of depositors, including wealth managers, Fortune 500 corporations, endowments, municipalities, family offices and others. The firm is comprised of 50+ professionals with deep expertise in banking, technology, and institutional-grade operations.
...
Forward-looking statements are subject to assumptions, risks and uncertainties that may cause actual results to differ materially from those contemplated by such forward-looking statements. The factors that could cause Fiserv’s actual results to differ materially include, among others: Fiserv’s ability to successfully integrate the operations of StoneCastle into those of Fiserv; conditions to the completion of the transaction may not be satisfied, or the regulatory approvals required for the transaction may not be obtained on the terms expected or on the anticipated schedule; the retention of key employees and clients of StoneCastle; and other factors included in “Risks Factors” in Fiserv’s filings with the SEC, including its Annual Reports on Form 10-K for the year ended December 31, 2024, and in other documents that it file with the SEC, which are available at www.sec.gov. You should consider these factors carefully in evaluating forward-looking statements and are cautioned not to place undue reliance on such statements. Fiserv assumes no obligation to update any forward-looking statements, which speak only as of the date of this press release.
