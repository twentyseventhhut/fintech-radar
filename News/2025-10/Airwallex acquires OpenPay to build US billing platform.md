---
title: "Airwallex acquires OpenPay to build US billing platform"
date: 2025-10-08
tags:
  - company/airwallex
  - company/openpay
...
sources:
  ...
  - https://www.paymentsdive.com/news/airwallex-openpay-billing-americas-expansion/803070
status: tagged
n_mentions: 2
channels:
...
# Airwallex acquires OpenPay to build US billing platform

> [!info] 2025-10-08 · 2 упоминаний · 1 источника(ов) с текстом
> Каналы: Connecting the Dots in Fintech

## Агрегированный текст (из дайджестов)

[Connecting the Dots in Fintech] 🇺🇸 Airwallex plots bigger US presence. The payments platform will use its recent acquisition of U.S. startup OpenPay to build out a billing platform in the Americas. By integrating OpenPay, Airwallex said it will create the first truly global billing platform by merging a global FinTech infrastructure with billing and subscription management.

[Connecting the Dots in Fintech] 🇺🇸 Airwallex Celebrates Dual Milestones. Airwallex hit two major milestones this week: acquiring billing platform OpenPay to advance its global, multi-currency solution, and winning the 2025 Pledge 1% Impact Award for its boosted volunteer efforts and $62M in community support.
