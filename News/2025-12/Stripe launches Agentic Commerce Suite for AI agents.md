---
title: "Stripe launches Agentic Commerce Suite for AI agents"
date: 2025-12-12
tags:
  - company/stripe
...
sources:
  ...
  - https://www.finextra.com/newsarticle/47055/stripe-launches-tech-to-help-firms-sell-through-ai-agents
  - https://www.bloomberg.com/news/articles/2025-12-09/stripe-and-paradigm-open-tempo-blockchain-to-public-add-kalshi-ubs-as-partners
status: tagged
n_mentions: 2
channels:
...
# Stripe launches Agentic Commerce Suite for AI agents

> [!info] 2025-12-12 · 2 упоминаний · 1 источника(ов) с текстом
> Каналы: This Week in Fintech

## Агрегированный текст (из дайджестов)

[This Week in Fintech] Stripe launched new technology that enables businesses to process payments and sell products directly through AI agents.

[This Week in Fintech] Stripelaunched its new Agentic Commerce Suite to help merchants make their products discoverable to AI agents, simplify agent-driven checkouts, and accept agentic payments through a single integration. Stripe and Paradigm also opened the Tempo blockchain to the public in a trial that invited companies to build real-world stablecoin payment applications, adding partners including Kalshi and UBS.
