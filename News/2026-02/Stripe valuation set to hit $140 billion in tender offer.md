---
title: "Stripe valuation set to hit $140 billion in tender offer"
date: 2026-02-10
tags:
  - company/stripe
  - industry/payments
...
sources:
  - https://stripe.com
  - https://www.bloomberg.com/news/articles/2026-02-09/stripe-valuation-set-to-hit-140-billion-in-new-tender-offer
...
# Stripe valuation set to hit $140 billion in tender offer

> [!info] 2026-02-10 · 3 упоминаний · 1 источника(ов) с текстом
> Каналы: Connecting the Dots in Fintech, The Fintech Blueprint

## Агрегированный текст (из дайджестов)

[Connecting the Dots in Fintech] Stripe is setting up a new tender offer that would push its valuation to $140B, a jump of more than $30B from last year.

[Connecting the Dots in Fintech] 🇺🇸 Stripe valuation set to hit $140 billion in new tender offer. The company, one of the most closely watched potential candidates for an initial public offering, has set up frequent tenders since 2024 as a way to let employees sell shares without going public. The latest deal is a sign that Stripe may continue to delay an IPO.

[The Fintech Blueprint] ⭐ Stripe eyes tender at more than $140B- Axios
...
Receive ongoing assistance and day-to-day support for technical questions with tiered plans based on your needs.
 ...
 Runway protects developer time with no-code solutions from Stripe. Read Runway's story   
 Supabase delivers its backend-as-a-service to 150 countries with Stripe. Read Supabase's story   
 Linear partners with Stripe to handle billing and payments. Read Linear's story   
 ElevenLabs grows into a US$3bn AI audio leader with Stripe. Watch the video   
 Browserbase offers usage-based billing for an AI agent browser with Stripe. Read Browserbase's story   
 Decagon decreases support costs by 65% with Stripe-integrated agents. Read Decagon's story   
...
Monetise platform transactions – including payments, card interchange and financing fees.
...
Get insights into how other brands have unified their online and in-store experiences and optimised their checkouts for a seamless shopping experience.
 Businesses on Stripe generated US$1.9tn in 2025. Our annual letter explores the trends defining the internet economy – including steeper growth for newer businesses, faster international expansion, stablecoin progress, agentic commerce, and more. Read the letter 
 150K+ users have their best day ever on Stripe. From Black Friday through Cyber Monday 2025, Stripe processed more than US$40bn for businesses while maintaining a 99.9999% uptime. See the numbers 
 Tidemark's vertical and SMB SaaS benchmark report. Learn what's driving growth in vertical SaaS in 2025 – going multiproduct, embedding fintech and integrating AI into the core of their products. Get the data 
 Shopify's Tobi Lütke sits down with John Collison. Hear them discuss the choices that shaped Shopify and Stripe, the future of commerce, and their advice for founders. Watch video 
 New tools to process payments outside app stores. New regulations mean new opportunities. Read how Stripe can help you process payments outside of the iOS and Android app stores, giving you more control and helping grow your revenue. Learn how 
 Crypto.com partners with Stripe to enable better crypto payments. Learn how the partnership can help you tap into a new global customer base by letting customers pay with their crypto balance directly at checkout. View announcement 
 Make your products shoppable through AI platforms. Find out how the Agentic Commerce Protocol (ACP) allows any business to accept purchases from AI platforms without requiring any major technical changes. Read more 
 How leading retailers unify customer experiences and drive growth. Get insights into how other brands have unified their online and in-store experiences and optimised their checkouts for a seamless shopping experience. Get the report 
Book of the week
