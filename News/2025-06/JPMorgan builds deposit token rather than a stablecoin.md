---
title: "JPMorgan builds deposit token rather than a stablecoin"
date: 2025-06-20
tags:
  - company/jpmorgan
...
sources:
  ...
  - https://blog.base.org/jpmorgan-is-moving-onchain-on-base
  - https://www.finextra.com/newsarticle/46172/jpmorgan-rises-to-stablecoin-challenge-with-roll-out-of-deposit-token
status: tagged
n_mentions: 1
channels:
...
# JPMorgan builds deposit token rather than a stablecoin

> [!info] 2025-06-20 · 1 упоминаний · 2 источника(ов) с текстом
> Каналы: This Week in Fintech

## Агрегированный текст (из дайджестов)

[This Week in Fintech] Interestingly, JP Morgan is specifically working on a deposit token and not a stablecoin. This may mean that it does not plan to provide users with yield, and that it plans to restrict transfers.
...
Key Links
 ...
 First bank issues USD deposit token on a public blockchain 
...
Beginning today, J.P. Morgan’s institutional clients can use JPM Coin to make near real-time peer-to-peer transfers between Ethereum Virtual Machine (EVM)-compatible wallets, providing the flexibility to transfer funds securely and efficiently with minimal delay. J.P. Morgan’s deposit token is also designed for integration with smart contracts on public blockchain networks, which could help facilitate complex financial workflows and automation in the future.
...
Check out media coverage in Bloomberg  and learn more about Kinexys by J.P. Morgan here . Dive into how other clients, such as Siemens , also leverage Kinexys by J.P. Morgan to run their businesses better.  
...
**TL;DR:**_J.P. Morgan is launching a USD-backed deposit token (JPMD) proof of concept on Base through_ _Kinexys by J.P. Morgan_ _, its industry-leading blockchain business unit. The pilot will enable an onchain payment rail that provides J.P. Morgan institutional clients the ability to eventually settle instantly and securely at a fraction of a cent. This is a major milestone in bringing traditional banking institutions onchain, and shows how Base helps banks build trusted financial products._
...
_J.P. Morgan’s deposit token (JPMD) is a permissioned product designed exclusively for eligible institutional clients and is not available to retail or individual consumers. Availability is limited to qualified institutional participants._
