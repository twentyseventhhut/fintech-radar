---
title: "This Week in Fintech: Bridge powers money movement for fintechs"
date: 2025-11-15
tags:
  - company/bridge
...
# This Week in Fintech: Bridge powers money movement for fintechs

> [!info] 2025-11-15 · 1 упоминаний · 1 источника(ов) с текстом
> Каналы: This Week in Fintech

## Агрегированный текст (из дайджестов)

[This Week in Fintech] Join Cenoa, Felix Pago, Metamask, Remitly, and thousands of others using Bridge to simplify money movement. Learn more here.
...
Challenge
‍
From day one, Cenoa’s goal was to build a new type of global financial platform that would help emerging market entrepreneurs overcome several key challenges:
‍ 
...
‍ Within nine months of launching its virtual USD accounts, Cenoa onboarded more than 50,000 SMBs and solopreneurs in Turkey and Nigeria, saw 50x transaction volume growth, and processed over $10 million in monthly volume. Cenoa’s customer onboarding time dropped to under three minutes, while its customer retention rate increased thanks to instant, reliable access to funds.
