---
title: "TWIF: Plaid profile and Zach Perret podcast note"
date: 2026-03-27
tags:
  - company/plaid
  ...
  - type/commentary
sources:
  - https://podcasts.apple.com/us/podcast/plaid-ceo-zach-perret-plaids-next-chapter-in-the-ai/id1669335245
status: tagged
n_mentions: 1
channels:
...
# TWIF: Plaid profile and Zach Perret podcast note

> [!info] 2026-03-27 · 1 упоминаний · 1 источника(ов) с текстом
> Каналы: This Week in Fintech

## Агрегированный текст (из дайджестов)

[This Week in Fintech] Plaid has been a big part of that story: we’ve profiled them to our readers and interviewed CEO Zach Perret on the podcast. We’ve been long-time admirers of the fintech-first platform they’ve built to scale financial innovation.
...
*   Great primer for the fintech industry. Very approachable with interesting guests. 
*   I really enjoy whenever a new episode of Hey Fintech Friends comes out. I enjoy hearing the headlines and the stories of the different guests in the fintech world. Helen is a fun an engaging host. Subscribe if you like all things fintech! 
